...
/// </summary>
public class Rinjdael:IEncryptor
{
    ...
    {
        return Encrypt(data, passPhrase, saltValue, hashAlgorithm, passwordIterations, initVector, keySize);
    }

    public string DecryptData(string data)
    {
        return Decrypt(data, passPhrase, saltValue, hashAlgorithm, passwordIterations, initVector, keySize);
    }
