...
namespace Orient.Client.Protocol
{
    public class Connection : IDisposable
    {
        ...
        public ODatabase Database { get; set; }

        public string DatabaseName { get; private set; }
        public ODatabaseType DatabaseType { get; private set; }
        ...
        public Connection(string hostname, int port, string databaseName, ODatabaseType databaseType, string userName, string userPassword, string alias, bool isReusable)
        {
            Hostname = hostname;
            Port = port;
        ...
        public Connection(string hostname, int port, string userName, string userPassword)
        {
            Hostname = hostname;
            Port = port;
        ...
        public ODocument ExecuteOperation<T>(T operation)
        {
